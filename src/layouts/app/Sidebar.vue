            ...
            <perfect-scrollbar class="list-unstyled menu-categories" tag="ul" :options="{ wheelSpeed: 0.5, swipeEasing: !0, minScrollbarLength: 40, maxScrollbarLength: 300, suppressScrollX: true }">
                <li class="menu">
                    <a class="dropdown-toggle" data-bs-toggle="collapse" data-bs-target="#dashboard" aria-controls="dashboard" aria-expanded="false">
                        <div class="">
                            ...
                            <router-link to="/tablero/inicio" @click="toggleMobileMenu"><span>Tablero (P)</span></router-link>
                        </div>
                ...
                <li class="menu">
                    ...
                    <ul id="apps" class="collapse submenu list-unstyled" data-bs-parent="#sidebar">
                        <li>
                            <router-link to="/tablero/nuevo" @click="toggleMobileMenu">Nuevo</router-link>
                        </li>
                    </ul>
                </li>
            </perfect-scrollbar>
