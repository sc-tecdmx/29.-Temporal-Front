...
onMounted(() => {
  getData("http://localhost/j/documentos/catTipoDocumento.php");
});
</script>
<template>
  <div class="row no-gutters justify-content-center">
    <div class="col-12 col-xxl-10">
      ...
      <div class="contenedor_cat">
        ...
        <!-- <ul>
          <li v-for="documento in data">
            {{ documento.label }}
            <ul>
              <li v-for="subDocumento in documento.sub_documento">{{ subDocumento.label }}</li>
            </ul>
          </li>
        </ul> -->
        ...
        <div class="d-flex flex-lg-column justify-content-start m-3">
          <div id="toggleAccordion" class="accordion">
            <div class="card" v-for="documento in data">
              <header class="card-header" role="tab">
                <section class="mb-0 mt-0">
                  <div
                    ...
                    :data-bs-target="`#${documento.id}`"
                    aria-expanded="true"
                    aria-controls="headingTwo1"
                  >
                    {{ documento.label }}
                    <div class="icons" v-if="documento.sub_documento">
              ...
              <div
                ...
                v-if="documento.sub_documento"
              >
                <div class="card-body">
                  <ul class="list-unstyled">
                    <li v-for="subDocumento in documento.sub_docuemnto">
                      {{ subDocumento.label }}
                    </li>
                  </ul>
                </div>
